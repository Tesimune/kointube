				...
				<div class="user-information">
					...
					<div class="user-fav">
						...
						<ul>
							...
							<li>
								<form action="db/auth/logout.php" method="post">
									<button type="submit" style="color: red;">Log out</button>
									<button><a href="upload.php" style="color: red;">Upload</a></button>
								</form>
							</li>
						</ul>
					...
					<form action="#" class="user">
						...
						<div class="row">
							<div class="col-md-6 form-it">
								...
								<input type="text" placeholder="Teslim">
							</div>
							<div class="col-md-6 form-it">
						...
						<div class="row">
							...
							<div class="col-md-6 form-it">
								...
								<input type="text" placeholder="Abdulwahab">
							</div>
						</div>
						<div class="row">
							<div class="col-md-2">
