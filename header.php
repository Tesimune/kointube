		...
		<div class="container">
			<nav class="navbar navbar-default navbar-custom">
				...
				<div class="navbar-header logo">
					...
					<a href="index-2.html"><img class="logo" src="images/logo.svg" alt="" width="119" height="58"></a>
				</div>
				...
				<div class="collapse navbar-collapse flex-parent" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav flex-child-menu menu-left">
						...
						<li>
							<a href="contentcreators.php" class="btn btn-default dropdown-toggle lv1">
								CONTENT CREATORS
							</a>

						</li>
						<li>
							<a href="movies.php" class="btn btn-default dropdown-toggle lv1">
								DISCOVER
							</a>
