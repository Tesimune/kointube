...
function register()
{
    ...
    global $db, $errors,  $username, $first_name, $last_name, $email;
    ...
    if (count($errors) == 0) {
        ...
        if (isset($_POST['user_type'])) {
            ...
            $query = "INSERT INTO users (first_name, last_name, username, email, user_type, password) 
					  VALUES('$first_name', '$last_name', '$username', '$email', '$user_type', '$password')";
            mysqli_query($db, $query);
            $_SESSION['success']  = "New user successfully created!!";
            header('location: home.php');
        } else {
            $query = "INSERT INTO users (first_name, last_name, username, email, user_type, password) 
					  VALUES('$first_name', '$last_name', '$username', '$email', 'user', '$password')";
            mysqli_query($db, $query);
